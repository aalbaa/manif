 ...
 *  Invariant Extended Kalmna Filter method.
 *
 *  ---------------------------------------------------------
 *
...
int main()
{
    ...
    Matrix<double, 2, 3>    H;
    H.topRightCorner<2, 2>().setIdentity();
    ...
    for (int t = 0; t < 10; t++)
    {
        ...
        for (int i = 0; i < NUMBER_OF_LMKS_TO_MEASURE; i++)
        {
            ...
            H.topLeftCorner<2, 1>() = manif::skew(-double(1)) * b;
        ...
        cout << "X estimated : " << X.log() << "\n";
        cout << "X unfilterd : " << X_unfiltered.log() << "\n";
        cout << "----------------------------------" << endl;
        // END DEBUG
